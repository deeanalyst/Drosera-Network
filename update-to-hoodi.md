...
nano drosera.toml
```
* Replace `https://relay.testnet.drosera.io` in `drosera_rpc` with new hoodi network relay url: `https://relay.hoodi.drosera.io`

* `eth_chain_id`: Delete this
* `drosera_address`: Delete the line
* `address`: Delete this
